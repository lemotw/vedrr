...
export const IpcCmd = {
  ...
  LIST_INBOX_ITEMS: "list_inbox_items",
  DELETE_INBOX_ITEM: "delete_inbox_item",
  FIND_SIMILAR_NODES_FOR_INBOX: "find_similar_nodes_for_inbox",
  MATCH_INBOX_TO_NODE: "match_inbox_to_node",
  MATCH_INBOX_TO_CONTEXT: "match_inbox_to_context",
